...
#trained_models_reg_spike=('NORMAL' 'WTA-1' 'SIM-A')
#trained_models_reg_spike=('NORMAL')
#trained_models_reg_spike=('WTA-1')
#trained_models_reg_spike=('WTA-A')
trained_models_reg_spike=('SIM-A-NEW')
#trained_models_reg_spike=('NORMAL' 'WTA-1')
#trained_models_reg_spike=('WTA-1' 'WTA-2' 'SIM-A' 'SIM-S')


for ((i_sm_batch_index=50;i_sm_batch_index<75;i_sm_batch_index++)) do
    for ((i_train_model=0;i_train_model<${#trained_models_reg_spike[@]};i_train_model++)) do
        ...
        { time python -u main_snn_training_WTA_SNN.py \
            ...
            -sm_batch_index=${i_sm_batch_index} \
            ; }
    done
done
        #-pooling_vgg='avg'\
