...
class ImageClass():
    ...
    def __init__(self):
        ...
        self.input_size_pre_crop_ratio=input_size_pre_crop_ratio
        self.num_class=num_class
        self.train=train
        self.input_prec_mode=input_prec_mode
        self.preprocessor_input=preprocessor_input


#def load(self, dataset_name,batch_size,input_size,input_size_pre_crop_ratio,num_class,
#    train,input_prec_mode,preprocessor_input):
    def load(self):
        ...
        input_size_pre_crop_ratio = self.input_size_pre_crop_ratio

        train = self.train
        input_prec_mode = self.input_prec_mode
        preprocessor_input = self.preprocessor_input
