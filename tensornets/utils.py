...
#		print(y)
	    ...
	    #print(layers_args[0])
	    #print(layers_args[1])
	    #print(len(layers_args))
	    #print(dir(layers_args))
	    #print(layers_args.index)
	    #print(dir(layers_args[0].gen))
	    #print(layers_args[0].gen.__name__)

#	    for attr in dir(layers_args):
#	   	print(attr)
#	    	print(getattr(layers_args,attr))
#
	    #for attr in dir(layers_args[0]):
	   #	print(attr)
#		print(getattr(layers_args[0],attr))
#
#	    for attr in dir(layers_args[0].gen):
#	   	print(attr)
#	    	print(getattr(layers_args[0].gen,attr))


	    #arg_test = layers_args[0]

		

	    #print(layers_args[0].__str__)

	    #layers_args[0].__dict__

	    #print(dir(layers_args[0]))
	    #print ', '.join("%s: %s" % item for item in layers_args[0].items())
	    #print(vars(layers_args[0]))
...
def pretrained_initializer(scope, values):
    print('util: pretrained_initializer')
    print(scope)
    ...
    f = open(model_name+'_weights.info','w')
    for w in weights:
        print(w)
	f.write(str(w)+'\n')
    f.close()
