...
#                            axs_tmp[1].pcolormesh(hist_accu_dec)
        ...
        if en_train == False:
            ...
            #status=load_model.restore(checkpoint_dir+'/ckpt-2167-1')
            #status=load_model.restore(checkpoint_dir+'/ckpt-1369-1')
            #status=load_model.restore(checkpoint_dir+'/ckpt-1055-1')
