...
def reg_tc_para(model):
    ...
    if model.t_train_tk_reg_mode=='I':
        ...
        elif model.t_train_tk_reg=='L1':
            l2_tc_w_init = tf.math.subtract(train_vars_tk_tc,model.init_tc)
            l2_td_w_init = tf.math.subtract(train_vars_tk_td,model.init_td_in)
        else:
            assert False
        ...
        if model.t_train_tk_reg=='L2':
            ...
            ret = tf.reduce_sum(train_vars_tk)
        else:
            assert False
