...
#log_root=/home/sspark/Projects/05_SNN/logs
log_root=./logs
...
log_file=${log_root}/log_${model_name}_${nn_mode}_${log_file_post_fix}
...
#	-n_type=$n_type\
#	-time_step=$time_step\
#	-n_init_vth=$vth ; } 2>&1 | tee $log_file



date=`date +%Y%m%d_%H:%M`
#log_file=log
log_file=${log_root}/log_${model_name}_${nn_mode}_${time_step}_${vth}_999_norm_${f_real_value_input_snn}_${date}
cat ${log_file}
