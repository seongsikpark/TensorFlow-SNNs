...
def load_inverted_res_block(model, weights, expansion, stride, alpha, filters, block_id):
    ...
    #model.get_layer(lname_d_t).depthwise_kernel.assign(weights[lname_cv_d_s][lname_cv_d_s]['depthwise_kernel:0'])
    #model.get_layer(lname_d_t+'_BN').beta.assign(weights[lname_bn_d_s][lname_bn_d_s]['beta:0'])
    #model.get_layer(lname_d_t+'_BN').gamma.assign(weights[lname_bn_d_s][lname_bn_d_s]['gamma:0'])
    #model.get_layer(lname_d_t+'_BN').moving_mean.assign(weights[lname_bn_d_s][lname_bn_d_s]['moving_mean:0'])
    #model.get_layer(lname_d_t+'_BN').moving_variance.assign(weights[lname_bn_d_s][lname_bn_d_s]['moving_variance:0'])
