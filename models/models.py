        ...
        for t in range(tw):
            ...
            if self.f_1st_iter == False:
                ...
                if t==self.accuracy_time_point[count_accuracy_time_point]-1:
                    ...
                    #tf.scatter_update(spike_count,[count_accuracy_time_point],self.n_fc3.vmem)
                    #print(tf.shape(self.spike_count))
                    #print(tf.shape(self.n_fc3.vmem))
                    self.spike_count.scatter_nd_update([count_accuracy_time_point],tf.expand_dims(self.n_fc3.vmem,0))
